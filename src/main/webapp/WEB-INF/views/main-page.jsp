    ...
    <div class="page-wrapper">
        <div class="container">
            ...
            <div class="tasks-container">
                <div class="task">
                    <div class="task__title"><span>Buy a ticket</span></div>
                ...
                <div class="task">
                    <div class="task__title"><span class="task__title_strikethrough">Wipe the table</span></div>
                    <div class="task__controls">
                        <form class="task__controls-form">
                            <button type="submit" class="button_type_close">
                                <svg width="24" height="24" viewBox="0 0 24 24">
                ...
                <div class="task">
                    <div class="task__title"><span>Fill the water barrel</span></div>
                    <div class="task__controls">
                        <form class="task__controls-form">
                            <button type="submit" class="button_type_approve">
                                <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="management-container">
                <form class="management-form">
                    <input type="text" name="title" placeholder="Write it down" class="management-form__input">
